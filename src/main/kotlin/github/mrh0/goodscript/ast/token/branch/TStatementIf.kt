...
import github.mrh0.goodscript.ir.IRStatementIf
import github.mrh0.goodscript.ir.IRStatementIfElse
...
class TStatementIf(location: Loc, private val conditions: List<ITok>, private val bodies: List<ITok>, private val elseBody: ITok?) : Tok(location) {
    override fun process(cd: CompileData): Pair<GsTypeBase, IIR> {
        ...
        conditionPairs.forEach { if(it.first != GsTypeBool) throw GsError("Expected if statement condition to be a boolean.") }
