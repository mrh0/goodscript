...
class Imported(private val name: String, private val type: GsTypeBase, private var value: GsBase) : IVar {
    override fun getName() = name
    override fun getType() = type
    override fun getValue(location: Loc) = value
    override fun setValue(location: Loc, value: GsBase) {
        throw GsError(location, "Cannot re-assign an imported constant")
    }
}